...
pars = {'pop_size': 20e3,
        'pop_type': 'hybrid',
        'location': 'lesotho', # Load age structure and household sizes
...
#sim.plot(do_save=1, do_show=0, to_plot=to_plot,fig_path=f'results/lesotho_sim')
...
def run_scens():
    ...
    scens.plot(do_save=1, do_show=0, to_plot=to_plot, fig_path=f'results/lesotho_scenarios_all', n_cols=2, fig_args=fig_args)
